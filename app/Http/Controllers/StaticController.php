...
{  
  ...
  {
    $count_checkhn =  User::where('hn_id','=',$iduser)->count();   
    
    return $count_checkhn;
  }

  //ผอ . เห็นชอบ
  public static function checkpo($iduser)
  {
    $count_checkpo =  User::where('po_id','=',$iduser)->count();   
    
    return $count_checkpo;
  }

   //สสอ . เห็นชอบ
   public static function checksso($iduser)
   {
     $count_checksso =  User::where('sso_id','=',$iduser)->count();   
     
     return $count_checksso;
   }
