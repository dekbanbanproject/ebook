                                ...
                                <div class="col-md-6">
                                    <div class="form-group"> 
                                        <input id="orginfo_name" type="text"
                                            class="form-control" name="orginfo_name">
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input id="orginfo_code" type="text"
                                            class="form-control" name="orginfo_code">
                                    </div>
                                </div> 
                            </div>
                            <div class="row mt-3">                                
                                ...
                                <div class="col-md-10"> 
                                    <div class="form-floating">
                                        <textarea class="form-control" id="orginfo_address" name="orginfo_address"></textarea>
                            ...
                            <div class="row mt-3">                                
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        class="form-control" name="orginfo_email" >
                                      </div>
                                </div>        
                                <div class="col-md-2 text-end">
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        class="form-control" name="orginfo_tel" >
                                      </div>
                                </div>                        
                            </div>
                            <div class="row mt-3">                                
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        class="form-control" name="orginfo_link" >
                                      </div>
                                </div>   
                                <div class="col-md-2 text-end">
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        class="form-control" name="sso_name" >
                                      </div>
                                </div>                                
                            </div>
                            <div class="row mt-3">  
