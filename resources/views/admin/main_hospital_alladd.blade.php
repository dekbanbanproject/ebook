    ...
    <div class="row mt-3">
        <div class="col-xl-12">
            <div class="card cardshadow">
                <div class="card-body">  
                    <form action="{{route('u.main_hospital_allsave')}}" method="POST" id="Insert_hospital" enctype="multipart/form-data">                 
                        @csrf        
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"> 
                                        <input id="orginfo_name" type="text"
                                            class="form-control form-control-sm" name="orginfo_name">
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input id="orginfo_code" type="text"
                                            class="form-control form-control-sm" name="orginfo_code">
                                    </div>
                                </div> 
                            </div>
                            <div class="row mt-3">                                
                                ...
                                <div class="col-md-10"> 
                                    <div class="form-group">
                                        <textarea class="form-control" id="orginfo_address" name="orginfo_address" cols="3"></textarea>
                            ...
                            <div class="row mt-3">                                
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        class="form-control form-control-sm" name="orginfo_email" >
                                      </div>
                                </div>        
                                <div class="col-md-2 text-end">
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        class="form-control form-control-sm" name="orginfo_tel" >
                                      </div>
                                </div>                        
                            </div>
                            <div class="row mt-3">                                
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        class="form-control form-control-sm" name="orginfo_link" >
                                      </div>
                                </div>   
                                <div class="col-md-2 text-end">
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        class="form-control form-control-sm" name="sso_name" >
                                      </div>
                                </div>                                
                            </div>
                            <div class="row mt-3">  
...
<script>
    $(document).ready(function() {
        ...
        $('#Insert_hospital').on('submit',function(e){
                  e.preventDefault();            
                  var form = this; 
                  $.ajax({
                          ...
                          if (data.status == 0 ) {
                            ...
                            Swal.fire({
                              ...
                              if (result.isConfirmed) {                  
                                window.location="{{url('main_hospital_all')}}";
                              }
                            })      
                          }
                        }
