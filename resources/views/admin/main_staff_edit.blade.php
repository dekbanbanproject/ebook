...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ route('a.main_staff_update') }}" method="POST" id="Update_staff" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-xl-3">
                ...
                <div class="col-xl-9">
                    <div class="card cardshadow">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="fname" name="fname" value="{{ $dataedits->fname }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="lname">นามสกุล :</label>
                                        <input type="text" class="form-control form-control-sm" id="lname" name="lname" value="{{ $dataedits->lname }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="username" name="username" value="{{ $dataedits->username }}" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="line_token" id="line_token" class="form-control form-control-sm" value="{{ $dataedits->line_token }}">
                            ...
                            <input type="hidden" name="id" id="id" value="{{$dataedits->id}}">
