    ...
    <div class="row mt-3">
        <div class="col-xl-12">
            <div class="card cardshadow">
                <div class="card-body">  
                    <form action="{{route('u.main_hospital_allupdate')}}" method="POST" id="Update_hospital" enctype="multipart/form-data">                 
                        @csrf        
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"> 
                            <div class="row mt-3">                                
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"> 
                                        <input id="orginfo_name" type="text" class="form-control form-control-sm" name="orginfo_name" value="{{$orginfo->orginfo_name}}">
                                    </div>
                                </div> 
                                    ...
                                    <div class="form-group">                                        
                                        <select id="head_sso_id" name="head_sso_id" class="form-control form-control-sm" style="width: 100%">
                                            <option value=""></option>
                                                ...
                                                @if ($orginfo->orginfo_po_id == $item1->id)
...
<script>
    $(document).ready(function() {
        ...
        $('#Update_hospital').on('submit',function(e){
                  e.preventDefault();            
                  var form = this; 
                  $.ajax({
