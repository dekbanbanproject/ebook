...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ route('u.user_profile_update') }}" method="POST" id="Update_profile"
                    ...
                    <div class="card cardshadow">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="fname"
                                            name="fname" value="{{ $dataedits->fname }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="lname"
                                            name="lname" value="{{ $dataedits->lname }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{ url('main_user') }}" class="ladda-button btn-pill btn btn-danger d-shadow">
