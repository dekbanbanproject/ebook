...
<body data-sidebar="white" data-keep-enlarged="true" class="vertical-collpsed">
    ...
    <div id="layout-wrapper">
        ...
        <header id="page-topbar">
            <div class="navbar-header" style="background-color: rgba(243, 119, 119, 0.884)">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box" style="background-color: rgb(255, 255, 255)">
                        <a href="" class="logo logo-dark">
                            ...
                            <span class="logo-lg">
                                ...
                                <h4 style="color:rgba(243, 119, 119, 0.884)" class="mt-4">U-Ebook</h4>
                            </span>
                        </a>
                    ...
                    <a href="{{url("main_user")}}" target="_blank">
                        <i class="fa-solid fa-2x fa-user-group text-white ms-4 me-2 mt-4" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="ผู้ใช้งานทั่วไป."></i>
                      </a>
